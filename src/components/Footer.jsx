    ...
    <footer className="bg-black text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            <h3 className="text-2xl font-light mb-6">Saksham</h3>
            <p className="text-gray-400 mb-6">
              Experience unparalleled luxury and hospitality at India's most iconic hotel.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Rooms & Suites</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li>info@saksham.com</li>
            </ul>
          </div>

          <div>
            <h4 className="text-lg font-light mb-6">Newsletter</h4>
            <p className="text-gray-400 mb-4">Subscribe to our newsletter for exclusive offers and updates.</p>
            <form className="flex">
              <input
                type="email"
                placeholder="Enter your email"
                className="bg-gray-800 text-white px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-white"
              />
